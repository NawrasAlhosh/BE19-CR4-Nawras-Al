  ...
  <div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" name="image" area-describility="image" id="image" value="<?php echo $row["image"]; ?>" />
      </div>
      <div class="mb-3 mt-3">
